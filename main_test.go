...
func (s *TestSuite) TestHandleCSV(c *C) {
	...
	c.Assert(tk.CalculatedTemperature, Equals, float64(-15.167599999999997))
...
func (s *TestSuite) TestHandleCSVWithSpaces(c *C) {
	...
	c.Assert(tk.CalculatedTemperature, Equals, float64(-15.555199999999996))
	...
	c.Assert(tk.CalculatedTemperature, Equals, float64(-15.426))
...
func (s *TestSuite) TestHandleCSVGarbage(c *C) {
	...
	c.Assert(tk.CalculatedTemperature, Equals, float64(-16.718))
