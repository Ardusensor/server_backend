...
func (s *TestSuite) TestHandleCSV(c *C) {
	...
	c.Assert(tk.Temperature, Equals, float64(-5.1676))
...
func (s *TestSuite) TestHandleCSVWithSpaces(c *C) {
	...
	c.Assert(tk.Temperature, Equals, float64(-5.555199999999999))
	...
	c.Assert(tk.Temperature, Equals, float64(-5.426000000000003))
...
func (s *TestSuite) TestHandleCSVGarbage(c *C) {
	...
	c.Assert(tk.Temperature, Equals, float64(-6.718000000000002))
